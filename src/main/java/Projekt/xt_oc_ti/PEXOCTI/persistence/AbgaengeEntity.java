...
@Entity(name = "Abgaenge")
public class AbgaengeEntity {
    ...
    public AbgaengeEntity(){
    }

    public AbgaengeEntity(UserEntity user, Double amount, String beschriftung, LocalDate datum){
        this.user = user;
        this.amount = amount;
